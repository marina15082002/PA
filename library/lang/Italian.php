...
class It
{
    public function getArray()
    {
        $lang = array(
            ...
            "NO_INCOMING_COLLECT_MSG" => "Nessuna raccolta in corso, creane una!",
            "INCOMING_COLLECT_MSG" => "In arrivo una raccolta fondi!",
            "STILL_SOME_INFORMATION_TO_CHECK" => "Ci sono ancora delle informazioni da controllare...",
            "NEXT" => "Seguente",
            "BACK" => "Indietro",
            "JAN" => "Gen",
            "FEB" => "Feb",
