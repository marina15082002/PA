    ...
    //import * as THREE from '<?php echo __DIR__ . '\library\three.js-master\build\three.module.js'; ?>';
    ...
    camera.position.set(780, 280, 30); //x, y, z
...
{
    basket = object;
    basket.scale.set(10, 10, 10);
    basket.rotation.y = -1.5708; // 90° in radians
    basket.position.set(700, 250, 10);
    scene.add( basket );
});
});
