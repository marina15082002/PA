                        ...
                        <div>
                            <div class='form-group'>
                                ...
                                <select name='type' class='form-control'>
                                    <option name='type' value=" . $lang['FIELD_COMPANY']; if (strtoupper($value['type']) == strtoupper($lang['FIELD_COMPANY'])){echo " selected";}; echo ">" . $lang['FIELD_COMPANY'] . "</option>
                                    <option name='type' value=" . $lang['FIELD_ASSOCIATION']; if (strtoupper($value['type']) == strtoupper($lang['FIELD_ASSOCIATION'])){echo " selected";}; echo ">" . $lang['FIELD_ASSOCIATION'] . "</option>
                                    <option name='type' value=" . $lang['FIELD_PARTICULAR']; if (strtoupper($value['type']) == strtoupper($lang['FIELD_PARTICULAR'])){echo " selected";}; echo ">" . $lang['FIELD_PARTICULAR'] . "</option>
                                </select>
                            </div>
